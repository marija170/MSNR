...
%   Zakomentarisao jer baca compile error
%    \item Nerves - Definiše novi način za izgradnju ugrađenih sistema koristeći Elixir. Posebno dizajniran za ugrađene sisteme, a ne za desktop ili serverske sisteme.
    \begin{itemize}
%        \item Platform - napravljene po zahtevu, minimalni Linux izvedeni iz Buildroot-a koji se pokreće direktno na BEAM VM.
        \item Framework - spremna biblioteka modula Elixir-a za brzo pokretanje
%        \item Tooling - moćne alatke komandne linije za upravljanje gradnjom, ažuriranje firmware-a, konfiguriranje uređaja i još mnogo toga
    \end{itemize}
%    Zajedno, platforma Nerver, okvir i alati pružaju visoko specijalizovano okruženje za korišćenje Elixir-a.
    \item Sugar - 
    \item Hedwig -
\end{itemize}
